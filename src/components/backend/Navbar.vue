          ...
          <template :class="{ block: showProfileMenu }">
            ...
            >
              ...
              <li class="lock">
                <a
                  @click="onClickLogout"
                  class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold text-red-500 transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800"
                  href="#"
                >
                  <svg
                    class="w-4 h-4 mr-3"
